...
println (smallerPic1Dimension, largerPic1Dimension, smallerPic2Dimension, largerPic2Dimension); //Berifying Variable Details (ID lerger dimensions)
...
rect(rectXPic2, rectYPic2, rectWidthPic2, rectHeightPic2); //Image 2, ladscape presentation
//image(pic1);
//image(pic2);
